...
exports.getDefaultAddresses = exports.EIP712_SAFE_OPERATION_TYPE_V07 = exports.EIP712_SAFE_OPERATION_TYPE_V06 = void 0;
...
async function toSafeSmartAccount(parameters) {
    ...
    const localOwners = await Promise.all(_owners
        ...
        .map((owner) => (0, toOwner_js_1.toOwner)({
        owner: owner
    })));
    const entryPoint = {
    ...
    const { safeModuleSetupAddress, safe4337ModuleAddress, safeProxyFactoryAddress, safeSingletonAddress, multiSendAddress, multiSendCallOnlyAddress } = (0, exports.getDefaultAddresses)(version, entryPoint.version, {
    ...
    return (0, account_abstraction_1.toSmartAccount)({
        ...
        async getStubSignature() {
            return (0, viem_1.encodePacked)(["uint48", "uint48", "bytes"], [
                0,
                0,
                `0x${owners
